...
import '../widgets/attendance_view_toggle.dart';
import '../widgets/calendar_view_widget.dart';
import '../widgets/list_view_widget.dart';
import '../widgets/monthly_header_card.dart';
...
class _MonthlySummaryScreenState extends State<MonthlySummaryScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      context.read<AttendanceReportProvider>().getAttendanceReport();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final summary = provider.reportModel?.summary;
                                              ...
                                              [
                                                ...
                                                summary == null ||
                                                        (summary.totalDays ??
                                                            ...
                                                            0
                                                    ? "0%"
                                                    : "${(((summary.presentDays ?? 0) / (summary.totalDays ?? 1)) * 100).toStringAsFixed(0)}%",
                                              ],
                                              [
                                                "Late",
                                                "${summary?.lateDays ?? 0}"
...
//                 decoration: BoxDecoration(
//                   color:
//                       isSelected ? const Color(0xff0A53FF) : Colors.transparent,
